...
const SUBCATEGORIES_BY_CATEGORY = {
  tops: ["Футболка", "Майка / топ", "Рубашка", "Блузка", "Водолазка", "Лонгслив", "Свитер / джемпер", "Кардиган", "Жилет"],
...
- Если на вещи есть принт/узор (горошек, цветы, клетка, полоска, леопардовый, зебра, животный принт и т.п.) — ОБЯЗАТЕЛЬНО заполни поле "patternColorIds" списком цветов узора. Пример: вещь с леопардовым принтом → colorId: "camel" (или "beige"), patternColorIds: ["brown", "black"]. ПЕРЕД отправкой ответа проверь себя: если в itemLabel или description вещи есть слово "леопардовый", "горошек", "цветочный", "клетка", "полоска", "зебра" или похожее — значит patternColorIds НЕ МОЖЕТ быть пустым массивом, в нём должно быть минимум 2 цвета. Это правило строго обязательно, не пропускай его.
