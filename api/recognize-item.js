...
Правила:
- Подкатегорию выбирай ТОЛЬКО если она точно описывает вещь по крою/конструкции — не выбирай "похожий" вариант, если он на самом деле другой. Например: майка или топ на тонких бретельках без рукавов — это НЕ "Футболка" (у футболки есть хотя бы короткие рукава); если в списке нет подходящего варианта — используй suggestedNewSubcategory, а subcategory оставь null.
- То же самое для цвета: если основной цвет вещи НЕ соответствует точно ни одному варианту из списка цветов — укажи suggestedNewColorLabel, а colorId оставь null. Не подбирай ближайший цвет силой.
